...
execute if score debug campfire_settings matches 1 if block ~ ~ ~ #minecraft:campfires[lit=true] align xyz positioned ~0.5 ~0.5 ~0.5 run function rme:campfire_leather/cook
